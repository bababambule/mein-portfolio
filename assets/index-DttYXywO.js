(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))n(t);new MutationObserver(t=>{for(const r of t)if(r.type==="childList")for(const i of r.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&n(i)}).observe(document,{childList:!0,subtree:!0});function s(t){const r={};return t.integrity&&(r.integrity=t.integrity),t.referrerPolicy&&(r.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?r.credentials="include":t.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(t){if(t.ep)return;t.ep=!0;const r=s(t);fetch(t.href,r)}})();function c(){const e=document.createElement("nav");return e.className="fixed top-0 left-0 right-0 z-50 bg-slate-900/80 backdrop-blur-md border-b border-slate-800",e.innerHTML=`
  ...
  `;const o=e.querySelector("#narrow-container"),s=e.querySelector("#medium-container"),n=e.querySelector("#wide-container");return o&&o.appendChild(d()),s&&s.appendChild(d()),n&&n.appendChild(d()),e}function x(){const e=document.getElementById("mobile-menu-button"),o=document.getElementById("mobile-menu-close"),s=document.getElementById("mobile-menu"),n=document.getElementById("mobile-menu-overlay"),t=document.querySelectorAll(".mobile-menu-link");function r(){s?.classList.remove("translate-x-full"),n?.classList.remove("opacity-0","pointer-events-none"),document.body.style.overflow="hidden"}function i(){s?.classList.add("translate-x-full"),n?.classList.add("opacity-0","pointer-events-none"),document.body.style.overflow=""}e?.addEventListener("click",r),o?.addEventListener("click",i),n?.addEventListener("click",i),t.forEach(a=>{a.addEventListener("click",i)}),document.addEventListener("keydown",a=>{a.key==="Escape"&&i()})}const l=document.querySelector("#app");document.body.insertBefore(c(),l);l.innerHTML="";l.appendChild(u());l.appendChild(p());l.appendChild(m());x();
