import{l as w,a as k,c as C,i as T}from"./mobileMenu-CVAXegPU.js";import{r as m,l as $,g as B,d as N,a as L,c as S}from"./Hero-Dy2HinBb.js";function j(e){const{text:s,variant:a="amberLight"}=e,t=document.createElement("div");t.textContent=s;const l="py-2 px-1 border-b-2 max-w-max text-xs",o={amberLight:"text-amber-50 border-amber-50",amberDark:"text-amber-400 border-amber-400",slate:"text-slate-400 border-amber-400",pill:"rounded-lg bg-slate-100 text-slate-600 border-0"};return t.className=`${l} ${o[a]}`,t}function E(e){const{text:s,type:a="h1",className:t=""}=e,l=document.createElement(a),o={h1:"text-4xl font-black",h2:"text-2xl/8 font-bold",h3:"text-lg font-bold",h4:"text-base font-bold"};return l.textContent=s,l.className=t||o[a],l}function f(e){const{blockVariant:s="amberDark",badgeText:a="",badgeVariant:t="amberLight",showBadge:l=!0,headingText:o="Headline",headingType:d="h1",body:c=""}=e,i=document.createElement("section"),p="w-full px-12",b={amberLight:"bg-amber-50 text-amber-800",amberDark:"bg-amber-600 text-amber-50",slateLight:"bg-slate-50 text-slate-800",slateDark:"bg-slate-600 text-slate-50"};i.className=`${p} ${b[s]} flex flex-col gap-4 py-12`;const h=j({text:a,variant:t}),y=E({text:o,type:d}),r=document.createElement("div");r.className="flex flex-col gap-2";const g=document.createElement("div");return g.className="",g.innerHTML=c,l&&r.appendChild(h),r.appendChild(y),i.appendChild(r),i.appendChild(g),i}const x="/mein-portfolio/assets/card-digital-prospekt-GvpxFVwl.webp";function z(){const e=document.createElement("section");e.className="bg-amber-600 py-12 flex flex-col gap-24 text-amber-50";const s=document.createElement("div");s.className="flex flex-col gap-0 px-6",s.innerHTML=`
  ...
  `,e.appendChild(s),e.appendChild(a),e.appendChild(t),e}function M(e){const{body:s,button:a=!0,variant:t="slate"}=e,l=document.createElement("section"),o="py-10 px-12",d={amber:"bg-amber-50",slate:"bg-slate-600"};l.className=`${o} ${d[t]}`;const c=a?"":"hidden",i=document.createElement("div"),p="rounded-2xl px-3 pt-2 pb-6 flex flex-col gap-6 font-mono",b={amber:"bg-slate-900 text-slate-400 bt-2 border-slate-400",slate:"bg-amber-900 text-amber-400 bt-2 border-amber-400"};return i.className=`${p} ${b[t]}`,i.innerHTML=`
  ...
  `,l.appendChild(i),l}function H(){const e=document.createElement("footer");return e.className="bg-slate-800 py-10 px-12 flex flex-col gap-8",e.innerHTML=`
  ...
  `,e}const n=document.querySelector("#app");n.className="bg-amber-600 text-base/6";const I=f({badgeText:"Case Studies",badgeVariant:"amberLight",showBadge:!0,headingText:"Selected Projects",headingType:"h2",body:`
  ...
  `}),v=f({blockVariant:"amberLight",showBadge:!1,headingText:"Always learning. Always building.",headingType:"h2",body:`
    ...
    `}),D=M({body:"Want to work with me?_",button:!0,variant:"amber"}),u=v.querySelector("#aboutButtonSlot");if(u){const e=L({text:"Learn More",href:"/about.html",variant:"primary",fullWidth:!1});u.appendChild(e)}document.body.insertBefore(C(),n);n.innerHTML="";n.appendChild(S());n.appendChild(I);n.appendChild(z());n.appendChild(v);n.appendChild(D);n.appendChild(H());T();
