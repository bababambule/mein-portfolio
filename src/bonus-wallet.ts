...
app.appendChild(
  contentBlock({
    ...
    headingType: "h1",
    body: `
    <p class="text-xl font-light text-amber-800">How I built a Progressive Web App that provides genuine customer value while saving furniture retailers 5,600 – 13,100 € per mailing.</p>
    <div class="-ml-6 -mr-6 my-6 grid grid-cols-2 gap-4">
      <div class="bg-amber-900/10 p-4 rounded-lg">
        <p class="text-2xl font-bold">64%</p>
        <p>Lower WhatsApp costs</p>
      </div>
      <div class="bg-amber-900/10 p-4 rounded-lg">
        <p class="text-2xl font-bold">€13,000</p>
        <p>Saved per customer mailing</p>
      </div>
      <div class="bg-amber-900/10 p-4 rounded-lg">
        <p class="text-2xl font-bold">8 Months</p>
        <p>From concept to beta</p>
      </div>
      <div class="bg-amber-900/10 p-4 rounded-lg">
        <p class="text-2xl font-bold">3 retailers</p>
        <p>Launching Q1 2026</p>
      </div>
    </div>
  `,
  })
